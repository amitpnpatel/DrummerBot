...
Beater beater1 = Beater(drumIdBeaterOne, &PORTF, &DDRF, calibrationForBeaterOne); //define beater
Beater beater2 = Beater(drumIdBeaterTwo, &PORTK, &DDRK, calibrationForBeaterTwo);
